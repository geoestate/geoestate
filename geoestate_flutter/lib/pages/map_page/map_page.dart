...
import 'package:geoestate_client/geoestate_client.dart' as myClient;
...
import '../../src/widgets/custom_marker_widget.dart';
import '../../src/widgets/custom_textfield.dart';
import '../create pages/select_bank_page.dart';
...
class _MapPageState extends State<MapPage> {
  ...
  @override
  void initState() {
    // Provider.of<MarkerProvider>(context).loadMarkers();
          ...
          children: [
            ...
            Consumer<MarkerProvider>(
              builder: (context, markerProvider, child) {
                if (markerProvider.markers!.isEmpty) {
                  noDataIcon();
                }
            ...
            Row(
              ...
              children: <Widget>[
                ...
                TextButton(
                    ...
                    onPressed: () {
                      removeExistingMarker(data[index].markerId);
                    },
                    child: const Text(
                      'Remove',
  ...
  Future<void> uploadNewMarkerData() async {
    ...
    try {
      ...
      (context).read<MarkerProvider>().createMarker(marker);
  ...
  // Future<QuerySnapshot<Map<String, dynamic>>> _searchMarkers() async {
  //   final searchValue = double.parse(_searchController.text);

  //   final query = await FirebaseFirestore.instance
  //       .collection('markers')
  //       .where('latitude', isGreaterThanOrEqualTo: searchValue)
  //       .where('longitude', isLessThanOrEqualTo: searchValue)
  //       .get();

  //   return query;
  // }

  removeExistingMarker(String markerId) async {
    ...
    try {
      ...
      context.read<MarkerProvider>().deleteMarker(marker);
    } catch (e) {
      showAlert(context, e.toString());
      return;
    }
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  try {
                    ...
                    //     .doc(markerId)
                    //     .update({
                    //   'marketRate': int.parse(_marketRateController.text),
                    //   'unit': _selectedUnit.toUpperCase(),
                    // });
                    // _marketRateController.clear();
                  } catch (e) {
                    showAlert(context, e.toString());
