...
import '../../src/widgets/custom_page2.dart';
...
Longitude: ${widget.longitude}°E""",
  ...
  void uploadData() async {
    ...
    String datasetId = const Uuid().v1();
    ...
    try {
      ...
      (context).read<DatasetProvider>().createDataset(dataset);
    } catch (e) {
      showAlert(context, e.toString());
      return;
    }
    ...
    Navigator.of(context).pushAndRemoveUntil(
        MaterialPageRoute(builder: (_) => const MapPage()), (route) => false);
